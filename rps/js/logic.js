...
function getResultsText(computerPick, playerPick) {
...
function playGame(yourPick) {
    ...
    switch(myPick) {
        case ROCK:
            ...
            case SCISSORS:
                scissorsR.classList.add("selected");
            break;
        }
        let result = document.getElementById("result");
        result.innerHTML = getResultsText(myPick, yourPick);
    }

    function setUp() {
        let game = document.getElementById("game");
        game.onanimationend =fumction() {
